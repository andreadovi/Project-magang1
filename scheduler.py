...
def get_deadline_idx(fill_date, fill_shift, resting_days):
    """
    Calculate latest allowed mixing shift index.
    - resting_days=0: 1 shift before filling
    - resting_days=2: mixing must finish 2 full calendar days before filling
      e.g. filling Monday any shift → mixing latest Friday shift 3
    """
    if resting_days == 0:
